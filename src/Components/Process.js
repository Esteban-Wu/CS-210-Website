        ...
        <Fade left duration={1000} distance="40px">
          ...
          <div className="row">
            <div className="three columns center-text" style={{ marginTop: "30px" }}>
              ...
              <a href={"documents/prd.pdf"} className="custom-button btn github-btn">
                <i className="fa fa-file-text"></i><span className="button-text-process">Proposal (PDF)</span>
              </a>
            </div>
            <div className="three columns center-text" style={{ marginTop: "30px" }}>
              <div className="process-icon">
              ...
              <a href={"documents/germany_presentation.pdf"} className="custom-button btn github-btn">
                <i className="fa fa-desktop"></i><span className="button-text-process">Slides (PDF)</span>
              </a>
            </div>          
            <div className="three columns center-text" style={{ marginTop: "30px" }}>
              <div className="process-icon">
              ...
              <a href={"images/diagram.png"} className="custom-button btn github-btn">
                <i className="fa fa-picture-o"></i><span className="button-text-process">Diagram (PNG)</span>
              </a>
            </div>          
            <div className="three columns center-text" style={{ marginTop: "30px" }}>
              <div className="process-icon">
              ...
              <a href={"documents/cod.pdf"} className="custom-button btn github-btn">
                <i className="fa fa-file-text"></i><span className="button-text-process">Deliverables (PDF)</span>
              </a>
            </div> 
          </div>
          <div className="row process-icon">
            <div className="three columns center-text" style={{ marginTop: "30px" }}>
              ...
              <a href={"https://www.canva.com/design/DAGDUmHMKT4/vKJZDT8G63vg2QXlM3Hb_g/view?utm_content=DAGDUmHMKT4&utm_campaign=designshare&utm_medium=link&utm_source=editor"} className="custom-button btn github-btn">
                <i className="fa fa-user"></i><span className="button-text-process">Profile (Canva)</span>
              </a>
            </div>
            <div className="three columns center-text" style={{ marginTop: "30px" }}>
              <div className="process-icon">
